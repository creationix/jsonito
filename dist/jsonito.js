...
export function writeDuplicates(rootVal, parts, known, willKnow) {
...
export function parse(jito, opts = {}) {
  const seen = []
...
export function parseAny(jito, offset, seen) {
...
export function skipWhitespace(str, offset) {
...
export function skipB64(str, offset) {
  const len = str.length
  let o = offset
