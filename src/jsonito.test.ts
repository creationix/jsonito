...
test("splitDecimal", () => {
  ...
  expect(splitDecimal(1.3310393152443792e308)).toEqual({ base: 13310393152443792n, exp: 292 })
  ...
  expect(splitDecimal(0.9999000099990001)).toEqual({ base: 9999000099990001n, exp: -16 })
})

test("round trip b64 encoding", () => {
  expect(decodeBigB64(encodeBigB64(0n))).toEqual(0n)
  expect(decodeBigB64(encodeBigB64(9n))).toEqual(9n)
  expect(decodeBigB64(encodeBigB64(10n))).toEqual(10n)
  expect(decodeBigB64(encodeBigB64(35n))).toEqual(35n)
  expect(decodeBigB64(encodeBigB64(36n))).toEqual(36n)
  expect(decodeBigB64(encodeBigB64(36n ** 2n))).toEqual(36n ** 2n)
  expect(decodeBigB64(encodeBigB64(36n ** 3n))).toEqual(36n ** 3n)
  expect(decodeBigB64(encodeBigB64(36n ** 4n))).toEqual(36n ** 4n)
  expect(decodeBigB64(encodeBigB64(36n ** 5n))).toEqual(36n ** 5n)
  expect(decodeBigB64(encodeBigB64(36n ** 6n))).toEqual(36n ** 6n)
  expect(decodeBigB64(encodeBigB64(36n ** 7n))).toEqual(36n ** 7n)
  expect(decodeBigB64(encodeBigB64(36n ** 8n))).toEqual(36n ** 8n)
  expect(decodeBigB64(encodeBigB64(36n ** 9n))).toEqual(36n ** 9n)
  expect(decodeBigB64(encodeBigB64(36n ** 10n))).toEqual(36n ** 10n)
  expect(decodeBigB64(encodeBigB64(36n ** 11n))).toEqual(36n ** 11n)
  expect(decodeBigB64(encodeBigB64(36n ** 12n))).toEqual(36n ** 12n)
  expect(decodeB64(encodeB64(0))).toEqual(0)
  expect(decodeB64(encodeB64(9))).toEqual(9)
  expect(decodeB64(encodeB64(10))).toEqual(10)
  expect(decodeB64(encodeB64(35))).toEqual(35)
  expect(decodeB64(encodeB64(36))).toEqual(36)
  expect(decodeB64(encodeB64(36 ** 2))).toEqual(36 ** 2)
  expect(decodeB64(encodeB64(36 ** 3))).toEqual(36 ** 3)
  expect(decodeB64(encodeB64(36 ** 4))).toEqual(36 ** 4)
  expect(decodeB64(encodeB64(36 ** 5))).toEqual(36 ** 5)
  expect(decodeB64(encodeB64(36 ** 6))).toEqual(36 ** 6)
  expect(decodeB64(encodeB64(36 ** 7))).toEqual(36 ** 7)
  expect(decodeB64(encodeB64(36 ** 8))).toEqual(36 ** 8)
  expect(decodeB64(encodeB64(36 ** 9))).toEqual(36 ** 9)
  expect(decodeB64(encodeB64(36 ** 10))).toEqual(36 ** 10)
  expect(decodeB64(encodeB64(36 ** 11))).toEqual(36 ** 11)
  expect(decodeB64(encodeB64(36 ** 12))).toEqual(36 ** 12)
  expect(decodeB64(encodeBigB64(0n))).toEqual(0)
  expect(decodeB64(encodeBigB64(9n))).toEqual(9)
  expect(decodeB64(encodeBigB64(10n))).toEqual(10)
  expect(decodeB64(encodeBigB64(35n))).toEqual(35)
  expect(decodeB64(encodeBigB64(36n))).toEqual(36)
  expect(decodeB64(encodeBigB64(36n ** 2n))).toEqual(36 ** 2)
  expect(decodeB64(encodeBigB64(36n ** 3n))).toEqual(36 ** 3)
  expect(decodeB64(encodeBigB64(36n ** 4n))).toEqual(36 ** 4)
  expect(decodeB64(encodeBigB64(36n ** 5n))).toEqual(36 ** 5)
  expect(decodeB64(encodeBigB64(36n ** 6n))).toEqual(36 ** 6)
  expect(decodeB64(encodeBigB64(36n ** 7n))).toEqual(36 ** 7)
  expect(decodeB64(encodeBigB64(36n ** 8n))).toEqual(36 ** 8)
  expect(decodeB64(encodeBigB64(36n ** 9n))).toEqual(36 ** 9)
  expect(decodeB64(encodeBigB64(36n ** 10n))).toEqual(36 ** 10)
  expect(decodeB64(encodeBigB64(36n ** 11n))).toEqual(36 ** 11)
  expect(decodeB64(encodeBigB64(36n ** 12n))).toEqual(36 ** 12)
  expect(decodeBigB64(encodeB64(0))).toEqual(0n)
  expect(decodeBigB64(encodeB64(9))).toEqual(9n)
  expect(decodeBigB64(encodeB64(10))).toEqual(10n)
  expect(decodeBigB64(encodeB64(35))).toEqual(35n)
  expect(decodeBigB64(encodeB64(36))).toEqual(36n)
  expect(decodeBigB64(encodeB64(36 ** 2))).toEqual(36n ** 2n)
  expect(decodeBigB64(encodeB64(36 ** 3))).toEqual(36n ** 3n)
  expect(decodeBigB64(encodeB64(36 ** 4))).toEqual(36n ** 4n)
  expect(decodeBigB64(encodeB64(36 ** 5))).toEqual(36n ** 5n)
  expect(decodeBigB64(encodeB64(36 ** 6))).toEqual(36n ** 6n)
  expect(decodeBigB64(encodeB64(36 ** 7))).toEqual(36n ** 7n)
  expect(decodeBigB64(encodeB64(36 ** 8))).toEqual(36n ** 8n)
  expect(decodeBigB64(encodeB64(36 ** 9))).toEqual(36n ** 9n)
  expect(decodeBigB64(encodeB64(36 ** 10))).toEqual(36n ** 10n)
  expect(decodeBigB64(encodeB64(36 ** 11))).toEqual(36n ** 11n)
  expect(decodeBigB64(encodeB64(36 ** 12))).toEqual(36n ** 12n)
  expect(decodeB64(encodeB64(Number.MAX_SAFE_INTEGER))).toEqual(Number.MAX_SAFE_INTEGER)
  expect(decodeSignedB64(encodeSignedB64(Number.MAX_SAFE_INTEGER))).toEqual(Number.MAX_SAFE_INTEGER)
  expect(decodeSignedB64(encodeSignedB64(Number.MIN_SAFE_INTEGER))).toEqual(Number.MIN_SAFE_INTEGER)
  expect(decodeSignedBigB64(encodeSignedBigB64(BigInt(Number.MAX_SAFE_INTEGER)))).toEqual(
    BigInt(Number.MAX_SAFE_INTEGER),
  )
  expect(decodeSignedBigB64(encodeSignedBigB64(BigInt(Number.MIN_SAFE_INTEGER)))).toEqual(
    BigInt(Number.MIN_SAFE_INTEGER),
  )
})

test("encode B64 digits", () => {
  expect(encodeBigB64(0n)).toEqual("")
  expect(encodeBigB64(1n)).toEqual("1")
  expect(encodeBigB64(9n)).toEqual("9")
  expect(encodeBigB64(10n)).toEqual("a")
  expect(encodeBigB64(35n)).toEqual("z")
  expect(encodeBigB64(64n)).toEqual("10")
  expect(encodeBigB64(14488732n)).toEqual("This")
  expect(encodeBigB64(1180n)).toEqual("is")
  expect(encodeBigB64(1955739563022n)).toEqual("strange")
  expect(encodeBigB64(BigInt(Number.MAX_SAFE_INTEGER))).toEqual("v________")
  expect(encodeBigB64(BigInt(Number.MAX_SAFE_INTEGER) + 1n)).toEqual("w00000000")
  expect(encodeBigB64(BigInt(Number.MAX_SAFE_INTEGER) - 1n)).toEqual("v_______-")
  expect(encodeSignedBigB64(0n)).toEqual("")
  expect(encodeSignedBigB64(-1n)).toEqual("1")
  expect(encodeSignedBigB64(1n)).toEqual("2")
  expect(encodeSignedBigB64(-9n)).toEqual("h")
  expect(encodeSignedBigB64(9n)).toEqual("i")
  expect(encodeSignedBigB64(-10n)).toEqual("j")
  expect(encodeSignedBigB64(10n)).toEqual("k")
  expect(encodeSignedBigB64(-35n)).toEqual("15")
  expect(encodeSignedBigB64(35n)).toEqual("16")
  expect(encodeSignedBigB64(-64n)).toEqual("1_")
  expect(encodeSignedBigB64(64n)).toEqual("20")
  expect(encodeSignedBigB64(7244366n)).toEqual("This")
  expect(encodeSignedBigB64(590n)).toEqual("is")
  expect(encodeSignedBigB64(977869781511n)).toEqual("strange")
})

test("round trip decimals", () => {
  expect(parse(stringify(1e-10))).toEqual(1e-10)
  expect(parse(stringify(-1e-10))).toEqual(-1e-10)
  expect(parse(stringify(0.123))).toEqual(0.123)
  expect(parse(stringify(0.123456))).toEqual(0.123456)
  expect(parse(stringify(0.123456789))).toEqual(0.123456789)
  expect(parse(stringify(123.456789))).toEqual(123.456789)
  expect(parse(stringify(123456.789))).toEqual(123456.789)
  expect(parse(stringify(123456789e9))).toEqual(123456789e9)
  expect(parse(stringify(123456789e-20))).toEqual(123456789e-20)
  expect(parse(stringify(123456789e20))).toEqual(123456789e20)
  expect(parse(stringify(123456789e-40))).toEqual(123456789e-40)
  expect(parse(stringify(123456789e40))).toEqual(123456789e40)
  expect(parse(stringify(123456789e-80))).toEqual(123456789e-80)
  expect(parse(stringify(123456789e80))).toEqual(123456789e80)
  expect(parse(stringify(123456789e-160))).toEqual(123456789e-160)
  expect(parse(stringify(123456789e160))).toEqual(123456789e160)
  expect(parse(stringify(123456789e-320))).toEqual(123456789e-320)
  // expect(parse(stringify(10000 / 10001))).toEqual(10000 / 10001)
  // expect(parse(stringify(10000 / 10003))).toEqual(10000 / 10003)
  // expect(parse(stringify(10000 / 10007))).toEqual(10000 / 10007)
  expect(parse(stringify(Math.PI))).toEqual(Math.PI)
  expect(parse(stringify(-Math.PI))).toEqual(-Math.PI)
  expect(parse(stringify(Math.E))).toEqual(Math.E)
  expect(parse(stringify(-Math.E))).toEqual(-Math.E)
  expect(parse(stringify(Math.SQRT2))).toEqual(Math.SQRT2)
  expect(parse(stringify(-Math.SQRT2))).toEqual(-Math.SQRT2)
  expect(parse(stringify(-Number.MAX_VALUE))).toEqual(-Number.MAX_VALUE)
  expect(parse(stringify(Number.MAX_VALUE))).toEqual(Number.MAX_VALUE)
  expect(parse(stringify(-Number.MIN_VALUE))).toEqual(-Number.MIN_VALUE)
  expect(parse(stringify(Number.MIN_VALUE))).toEqual(Number.MIN_VALUE)
})
...
test("encode decimals", () => {
  ...
  expect(stringify(10000 / 10001)).toEqual("v:1731d28Rfy.")
  expect(stringify(10000 / 10003)).toEqual("v:17271eVjl2.")
  expect(stringify(10000 / 10007)).toEqual("v:170iK6cGvu.")
  ...
  expect(stringify(Math.SQRT2)).toEqual("v:1Av6kkrUUe.") // 1.4142135623730951
  expect(stringify(-Math.SQRT2)).toEqual("v:1Av6kkrUUd.") // -1.4142135623730951
  expect(stringify(-Number.MAX_VALUE)).toEqual("98:1_KZz-nRVF.")
  expect(stringify(Number.MAX_VALUE)).toEqual("98:1_KZz-nRVG.")
...
test("decode B64 strings", () => {
  expect(parseBigB64("0", 0, 0)).toEqual(0n)
  expect(parseBigB64("0", 0, 1)).toEqual(0n)
  expect(parseBigB64("1", 0, 1)).toEqual(1n)
  expect(parseBigB64("9", 0, 1)).toEqual(9n)
  expect(parseBigB64("a", 0, 1)).toEqual(10n)
  expect(parseBigB64("z", 0, 1)).toEqual(35n)
  expect(parseBigB64("A", 0, 1)).toEqual(36n)
  expect(parseBigB64("Z", 0, 1)).toEqual(61n)
  expect(parseBigB64("-", 0, 1)).toEqual(62n)
  expect(parseBigB64("_", 0, 1)).toEqual(63n)
  expect(parseBigB64("10", 0, 2)).toEqual(64n)
  expect(parseBigB64("This", 0, 4)).toEqual(14488732n)
  expect(parseBigB64("is", 0, 2)).toEqual(1180n)
  expect(parseBigB64("strange", 0, 7)).toEqual(1955739563022n)
  expect(parseBigB64("HelloWorld", 0, 10)).toEqual(778653614416704845n)
})
...
test("decode decimals", () => {
  ...
  expect(parse("98:1_KZz-nRVH.")).toEqual(-Number.MAX_VALUE)
