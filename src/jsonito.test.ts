...
import { stringify, encodeVarint, encodeSignedVarint, splitDecimal } from './jsonito.ts'
...
test('encode B64 digits', () => {
  expect(encodeVarint(0n)).toEqual('')
  expect(encodeVarint(1n)).toEqual('1')
  expect(encodeVarint(9n)).toEqual('9')
  expect(encodeVarint(10n)).toEqual('a')
  expect(encodeVarint(35n)).toEqual('z')
  expect(encodeVarint(64n)).toEqual('10')
  ...
  expect(encodeSignedVarint(-9n)).toEqual('h')
  expect(encodeSignedVarint(9n)).toEqual('i')
  expect(encodeSignedVarint(-10n)).toEqual('j')
  expect(encodeSignedVarint(10n)).toEqual('k')
  expect(encodeSignedVarint(-35n)).toEqual('15')
  expect(encodeSignedVarint(35n)).toEqual('16')
  expect(encodeSignedVarint(-64n)).toEqual('1_')
  expect(encodeSignedVarint(64n)).toEqual('20')
  expect(encodeSignedVarint(7244366n)).toEqual('This')
  expect(encodeSignedVarint(590n)).toEqual('is')
